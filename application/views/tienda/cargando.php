...
<?php
// Variable para saber si debo o no direccionar 
$redirect_url = (is_null($this->session->tempdata('redirectToCurrent'))) ?  false : true;
// URL donde se debe direccionar
$url = (is_null($this->session->tempdata('redirectToCurrent'))) ?  site_url('CO/pereira') : $this->session->tempdata('redirectToCurrent');
?>
