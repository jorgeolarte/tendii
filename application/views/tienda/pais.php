        ...
        <div class="container-fluid bg-inscripcion">
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-6 bg-white p-4 text-center">
                    ...
                    <h1 class="h3 mt-4 text-center">Elije tu país</h1>
                    <div class="list-group text-left">
                        <?php foreach ($paises as $pos => $pais) { ?>
                            <a href="<?= site_url($pais['ISO']) ?>" class="list-group-item list-group-item-action d-flex justify-content-between">
                                <div>
                                    <img src="<?= base_url('assets/img/banderas/' . $pais['bandera']) ?>" alt="<?= $pais['nombre'] ?>">&nbsp; <?= $pais['nombre'] ?>
                                </div>
